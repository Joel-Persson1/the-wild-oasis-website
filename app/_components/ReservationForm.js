...
function ReservationForm({ cabin, user }) {
  ...
  return (
    <div className="scale-[1.01]">
      <div className="bg-primary-800 text-primary-300 px-2 md:px-16 py-2 flex justify-between items-center">
        <p>Logged in as</p>
      ...
      <form
        ...
        className="bg-primary-900 py-2 px-4 md:py-10 md:px-16 text-lg flex gap-5 flex-col min-h-[400px] "
      >
